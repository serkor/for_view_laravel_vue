                ...
                <div class="box_account box">
                    ...
                    <template>
                        ...
                        <b-table :data="orders">
                            ...
                            <b-table-column field="customer"
                                            :label="lang.customer"
                                            sortable v-slot="props"
                                            :searchable="dateSearch"
                                            :custom-search="searchCuName">
...
export default {
    name: "ExecutorOrdersListProfile",
    props: ['executor', 'lang'],
    data() {
        return {
            isFullPage: false,
    ...
    methods: {
        ...
        searchCuName(row, input) {
            return input && row.customer.name && row.customer.name.includes(input);
        },
        dateFormat(val) {
        ...
        getResults(page = 1) {
            this.isLoading = true
            axios.patch('/account/get-list-executor-orders?page=' + page, {
